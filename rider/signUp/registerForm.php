...
<label for="selfieImage">Upload Selfie with IC:</label>
<input type="file" id="selfieImage" name="IC" accept="image/*" required>

<label for="licenseImage">Upload Driving License:</label>
<input type="file" id="licenseImage" name="license" accept="image/*" required>
