...
if (isset($_POST['submit'])) {
  ...
  $_SESSION['backupEmail']=$backupEmail;  
    ...
    $sql = "UPDATE users SET ChangePwdEmailCode = ?, ChangePwdbackupEmailCode = ? WHERE email = ?";
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->Body = "<p>Your verification code for primary email {$email} is: <strong> $ChangePwdEmailCode </strong></p>
            ...
            $mail->Body = "<p>Your verification code for backup email {$backupEmail} is: <strong> $ChangePwdbackupEmailCode </strong></p>
            <p>Please enter this code on the verification page to verify your account.</p>";
            $mail->send();
