...
// Query all sales data (from all sellers)
$stmt = $conn->prepare("
...
<html>
<head>
    <title>Admin - Advanced Sales Analytics</title>
...
<body>
<div id="container">
    <h1>📊 Admin - Total Platform Sales Analytics</h1>
    ...
    <div class="chart-container">
        <h2>Line Chart: Platform-wide Sales Over Time</h2>
        ...
        new Chart(ctx, {
            ...
            options: {
                ...
                plugins: {
                    ...
                    title: {
                        display: true,
                        text: 'Total Daily Sales (All Sellers)'
                    }
                },
                scales: {
                    y: {
